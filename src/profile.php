...
$templateParams["content"] = "../template/profilepage.php";
                ...
                <div class="col-12 col-md-8">
                    <nav class="navbar navbar-expand-md navbar-light" style="background-color: #49acf3;">
                        ...
                        <ul class="nav nav-pills ms-auto">
                            <li> <button type="button" onclick='location.href=("./settings.html")'
                                    class="btn btn-light"><span class="bi bi-gear-fill"></span></button></li>
                        </ul>
                    </nav>
                </div>
                <div class="col-md-2"></div>
            ...
            <nav class="col-12 col-md-8">
                <ul class="nav nav-pills nav-justified" style="background-color: #49acf3;">
                    ...
                    <li class="nav-item col-3 col-md-3">
                        <a href="#" class="btn btn-primary"><span class="bi bi-person-fill"></span><br>
                            <div>Profile</div>
                        </a>
                    </li>
                </ul>
