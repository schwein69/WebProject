...
<label for="searchBox" class="invisibleLabel"><?php echo $lang["Search"];?> chat</label>
<input id="searchBox" aria-label="<?php echo $lang["Search"];?> chat" type="search" placeholder="<?php echo $lang["Search"];?>..."/>
</div>
