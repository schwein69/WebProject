        ...
        <article class="bg-white border border-primary py-3">
            <div class="card col-10 col-md-8 mx-auto">
                <div class="card-header">
                    <div class="row mt-2">
                        <div class="col-4"> <img class="img-fluid rounded" src="../imgs/uploads/childe.jpg" alt=""
                                style="width: auto; max-width: 25%;" /></div>
                        <div class="col-4">
                            <h2 style="font-size: 2vw">Username</h2>
                        </div>
                        <div class="col-4"> <button type="button" class="btn btn-light btn-md border border-dark"
