<div class="row mt-5 privacy-body col-12 col-md-8 mx-auto ">
    <div class="privacy">
        ...
        <p>Ultimo aggiornamento: 23 gennaio 2023</p>
        <p>Questa Informativa sulla privacy descrive le nostre politiche e procedure sulla raccolta, l'uso e la
            divulgazione delle tue informazioni quando utilizzi il Servizio e ti informa sui tuoi diritti alla privacy e
            su come la legge ti protegge.</p>
        <p>Utilizziamo i tuoi dati personali per fornire e migliorare il servizio. Utilizzando il Servizio, accetti la
            raccolta e l'utilizzo delle informazioni in conformità con la presente Informativa sulla privacy. Questa
            Informativa sulla privacy è stata creata con l'aiuto del
            <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Generatore
                gratuito di Informativa sulla privacy .</a>.
        </p>
        <h2>Interpretazione e definizioni</h2>
        <h3>Interpretazione</h3>
        <p>Le parole la cui lettera iniziale è maiuscola hanno significati definiti alle seguenti condizioni. Le
            seguenti definizioni hanno lo stesso significato indipendentemente dal fatto che appaiano al singolare o al
            plurale.
        </p>
        <h3>Definizioni</h3>
        ...
        <ul>
            <li>
                <p><strong>Account</strong> indica un account univoco creato per te per accedere al nostro Servizio o a
                    parti del nostro Servizio.</p>
            </li>
            <li>
                <p><strong>Affiliata</strong> indica un'entità che controlla, è controllata da o è soggetta a comune
                    controllo con una parte, dove &quot;controllo&quot; indica la proprietà del 50% o più delle azioni,
                    partecipazioni azionarie o altri titoli aventi diritto di voto per l'elezione degli amministratori o
                    di altra autorità di gestione.</p>
            </li>
            <li>
                <p><strong>La Società</strong> indicata come "la Società", "Noi", "Noi" o "Nostro" nel presente
                    Contratto) si riferisce a Lynkzone.</p>
            </li>
            <li>
                <p><strong>Cookies</strong> sono piccoli file che vengono inseriti sul tuo computer, dispositivo mobile
                    o qualsiasi altro dispositivo da un sito Web, contenente i dettagli della tua cronologia di
                    navigazione su quel sito Web tra i suoi numerosi usi.
                </p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Dispositivo</strong> indica qualsiasi dispositivo che può accedere al Servizio come un
                    computer, un cellulare o un tablet digitale.</p>
            </li>
            <li>
                <p><strong>I dati personali</strong> ono tutte le informazioni relative a un individuo identificato o
                    identificabile.
                </p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Fornitore di servizi</strong> indica qualsiasi persona fisica o giuridica che elabora i dati
                    per conto della Società. Si riferisce a società o persone terze impiegate dalla Società per
                    facilitare il Servizio, per fornire il Servizio per conto della Società, per eseguire servizi
                    relativi al Servizio o per assistere la Società nell'analisi di come viene utilizzato il Servizio.
                </p>
            </li>
            <li>
                <p><strong>I Dati di utilizzo</strong> si riferiscono ai dati raccolti automaticamente, generati
                    dall'uso del Servizio o dall'infrastruttura del Servizio stesso (ad esempio, la durata di una visita
                    alla pagina).</p>
            </li>
            <li>
                <p><strong>Il sito Web</strong> fa riferimento a Lynkzone, accessibile da <a
                        href="http://localhost/WebProject/src/index.php" rel="external nofollow noopener"
                        target="_blank">http://localhost/WebProject/src/index.php</a></p>
            </li>
            <li>
                <p><strong>Tu</strong> Si intende la persona che accede o utilizza il Servizio, o la società o altra
                    entità legale per conto della quale tale persona accede o utilizza il Servizio, a seconda dei casi.
                </p>
            </li>
        </ul>
        ...
        <p>Quando accedi al Servizio da o tramite un dispositivo mobile, potremmo raccogliere determinate informazioni
            automaticamente, inclusi, a titolo esemplificativo ma non esaustivo, il tipo di dispositivo mobile che
            utilizzi, l'ID univoco del tuo dispositivo mobile, l'indirizzo IP del tuo dispositivo mobile, sistema
            operativo, il tipo di browser Internet mobile utilizzato, identificatori univoci del dispositivo e altri
            dati diagnostici.</p>
        ...
        <p>Utilizziamo cookie e tecnologie di tracciamento simili per tracciare l'attività sul nostro servizio e
            ...
            raccogliere e tenere traccia delle informazioni e per migliorare e analizzare il nostro servizio. Le
        ...
        <ul>
            <li><strong>Cookie o Cookie del browser.</strong> Un cookie è un piccolo file posizionato sul tuo
                dispositivo. Puoi istruire il tuo browser a rifiutare tutti i cookie o a indicare quando viene inviato
                un cookie. Tuttavia, se non accetti i cookie, potresti non essere in grado di utilizzare alcune parti
                del nostro servizio. A meno che tu non abbia regolato le impostazioni del tuo browser in modo tale da
                rifiutare i cookie, il nostro Servizio potrebbe utilizzare i cookie.</li>
            <li><strong>Web beacon.</strong> Alcune sezioni del nostro Servizio e le nostre e-mail possono contenere
                piccoli file elettronici noti come web beacon (noti anche come clear gif, pixel tag e single-pixel gif)
                che consentono alla Società, ad esempio, di contare gli utenti che hanno visitato tali pagine o ha
                aperto un'e-mail e per altre statistiche relative al sito Web (ad esempio, registrando la popolarità di
                una determinata sezione e verificando l'integrità del sistema e del server).</li>
        </ul>
        <p>I cookie possono essere &quot;persistenti&quot; o &quot;di sessione&quot; I cookie persistenti rimangono sul
            tuo personal computer o dispositivo mobile quando vai offline, mentre i cookie di sessione vengono eliminati
            non appena chiudi il browser web. Ulteriori informazioni sui cookie nell'articolo del <a
                href="https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking"
                target="_blank">sito Web sulla politica sulla privacy gratuita.</a></p>
        ...
        <ul>
            <li>
                ...
                <p>Scopo: questi cookie sono essenziali per fornirti i servizi disponibili attraverso il sito Web e per
                    consentirti di utilizzare alcune delle sue funzionalità. Aiutano ad autenticare gli utenti e
                    prevenire l'uso fraudolento degli account utente. Senza questi cookie, i servizi che hai richiesto
                    non possono essere forniti e utilizziamo questi cookie solo per fornirti tali servizi.</p>
            </li>
            <li>
                <p><strong>Cookies Policy / Avviso Accettazione Cookies</strong></p>
            ...
            <li>
                ...
                <p>Scopo: questi cookie ci consentono di ricordare le scelte effettuate dall'utente durante l'utilizzo
                    del sito Web, ad esempio ricordare i dettagli di accesso o le preferenze della lingua. Lo scopo di
                    questi cookie è quello di fornirti un'esperienza più personale e di evitare che tu debba reinserire
                    le tue preferenze ogni volta che usi il sito web.
                </p>
            </li>
        </ul>
        <p>Per ulteriori informazioni sui cookie che utilizziamo e sulle tue scelte in merito ai cookie, visita la
            nostra Informativa sui cookie o la sezione Cookie della nostra Informativa sulla privacy.</p>
        <h3>Uso dei tuoi dati personali</h3>
        <p>La Società può utilizzare i Dati Personali per le seguenti finalità:</p>
        <ul>
            <li>
                <p><strong>Per fornire e mantenere il nostro Servizio </strong>, incluso per monitorare l'utilizzo del
                    nostro Servizio.
                </p>
            </li>
            <li>
